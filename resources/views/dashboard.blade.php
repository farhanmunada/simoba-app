...
<div class="row mt-4">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-3">
                    <strong>SIMOBA (Sistem Informasi Peminjaman Mobil Bappeda)</strong> adalah sistem yang dirancang untuk mengelola peminjaman kendaraan dinas di lingkungan Badan Perencanaan Pembangunan Daerah.
                </p>

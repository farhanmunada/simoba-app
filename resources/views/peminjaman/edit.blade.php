                ...
                <form action="{{ route('peminjaman.update', $peminjaman) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" 
                               ...
                               value="{{ old('waktu_peminjaman', $peminjaman->waktu_peminjaman->format('Y-m-d\TH:i')) }}" 
                               required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="nama_acara" 
                               name="nama_acara" 
                               value="{{ old('nama_acara', $peminjaman->nama_acara) }}" 
        ...
        <div class="card">
            ...
            <div class="card-body">
                <small class="text-muted">
                    ...
                    • Waktu: {{ $peminjaman->waktu_peminjaman->format('d/m/Y H:i') }}<br><br>

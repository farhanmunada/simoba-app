...
@section('title', 'Tambah Mobil - SIMOBA')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <small class="text-muted">
                    ...
                    Masukkan nama/merk mobil dengan jelas.<br><br>
                    
                    <strong>Nomor Polisi:</strong><br>
                    Masukkan nomor polisi dengan format yang benar (contoh: B 1234 ABC).<br><br>
                    
                    <strong>Keterangan:</strong><br>
                    Informasi tambahan tentang mobil (opsional).
                </small>
            </div>
        </div>
    </div>
